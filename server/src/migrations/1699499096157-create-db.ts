...
export class CreateDb1699499096157 implements MigrationInterface {
    name = 'CreateDb1699499096157'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Event" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" nvarchar(256) NOT NULL, "date" date NOT NULL, "description" nvarchar(2048) NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "EventDetail" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" nvarchar NOT NULL, "eventId" integer, "characterId" integer)`);
